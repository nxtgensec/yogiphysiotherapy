...
export function AboutDoctor() {
  ...
  return (
    <section id="doctor" className="relative overflow-hidden py-20 md:py-28">
      ...
      <div ref={ref} className="reveal mx-auto grid max-w-7xl items-center gap-14 px-4 md:px-6 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7">
          <span className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">{t.doctor.eyebrow}</span>
          ...
          <div className="mt-8">
            <Button asChild size="lg" className="h-12 rounded-full bg-gradient-primary px-6 text-base font-semibold text-primary-foreground shadow-elevated">
